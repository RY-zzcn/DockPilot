...
- `--version`：指定版本，例如 `v0.2.2`；默认使用 latest release。
...
```bash
wget https://github.com/RY-zzcn/DockPilot/releases/download/v0.2.2/dockpilot-agent_0.2.2_linux_amd64.tar.gz
tar -xzf dockpilot-agent_0.2.2_linux_amd64.tar.gz
